...
source_repo = "git@github.com:jdrivas/testwebsite.git"
source_directory = "site"
website_test_bucket = "jdrivas.com"
website_staging_bucket = "jdrivas.com"
website_production_bucket = "jdrivas.com"
...
task :deploy_test => aws_key_file_name do
  tmp_clone = "/tmp/test_clone"
  ...
  update_files(keys, website_test_bucket, website_source, files)
